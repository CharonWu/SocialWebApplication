...
class EditCommentView extends React.Component{
    ...
    save(){
        this.props.editPost(this.props.id, this.state.text, "comment", this.props.commentId);
    }
    ...
    render() {
        return (
            <div className="modal fade" id={`edit`+`${this.props.commentId}`+`-comment`+`${this.props.id}`} data-bs-backdrop="static" data-bs-keyboard="false"
